...
3. As long as no unexpected errors are encountered, the tool will create a "TrackMySkyCards_Import.csv" in the same folder. Import this file following the instructions in the [TrackMySkyCards Import](#trackmyskycards-import) section.
