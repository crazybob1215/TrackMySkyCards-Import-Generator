...
3. As long as no unexpected errors are encountered, the tool will create a "TrackMySkyCards_Import.csv" in the same folder. Import this file into the [TrackMySkyCards](trackmyskycards-import) site and that should be it.
